...
const title = "Throne of Glass";
const author = "SJM";
let bookRating = 5;
let copiesSold = 10000;
...
// --v-- write your code here --v--
function logBookData(title, author, bookRating, copiesSold) {
  console.log(
    "The Book " +
      title +
      ", written by " +
...
logBookData("Throne of Glass", "SJM", 5, 120000);
logBookData("Throne of Glass", "SJM", 5, 130000);
logBookData("Throne of Glass", "SJM", 5, 140000);
