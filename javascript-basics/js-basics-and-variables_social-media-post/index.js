...
const titleForPost = "Hello, Insta!";
const textForPost = "This is my first post.";
let numberOfLikes = 42;
const Username = "I-the-User";
...
// --v-- write your code here --v--
console.log(titleForPost, textForPost, numberOfLikes, Username, isReported);
numberOfLikes++;
