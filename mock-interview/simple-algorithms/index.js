...
function averageWordLength(words2) {
  ...
  return (
    words2.reduce((accumulator, currentValue) => {
...
function doesWordExist(toastbrot, cupcake) {
  // TODO:
  return toastbrot.includes(cupcake);
}
...
function howManyTimes(toastbrot, cupcake) {
  // TODO:
  return toastbrot.filter((word) => word === cupcake).length;
}
...
// console.logs vorheriger Aufgaben:
